...
const Footer = () => {
  ...
  return (
    <section
      ...
      className="bg-primary text-white flex flex-col items-center bg-gradient-to-tl from-primary-600 via-primary/80 to-white md:bg-gradient-to-l"
    >
      {/* links */}
        ...
        <div className="w-full flex gap-10">
          ...
          <div className="w-1/2 flex flex-col pt-5 gap-5">
            ...
            <ul className="text-center capitalize">
              ...
              <li>
                <Link to="/shortage" className="hover:text-tertiary">
                  shortages
                </Link>
              </li>
              <li>
