  ...
  return (
    <section aria-labelledby="services-heading">
      <div className="w-full h-full pt-36 bg-primary-400">
        <h1
          id="services-heading"
          className="py-10 text-center text-white text-4xl font-semibold capitalize"
        >
          Services
        </h1>
        <ServiceArticleCard services={services} />
      </div>
      <div className="relative w-full h-full flex flex-col items-center justify-center gap-10 py-20 px-5 text-lg md:px-0">
        ...
        <p className="text-center">
          For inquiries, please contact us on <br />
          <a
