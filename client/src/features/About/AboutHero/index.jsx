  ...
  return (
    <section aria-label="About Hero Section">
      <div
        ...
        role="img"
        aria-label="About Hero Background Image"
      >
        <div className="absolute inset-0 w-full h-screen bg-black/30">
          <div className="w-full h-full flex flex-col items-start justify-center p-5 mt-12 md:px-10 md:pt-28 md:mt-0">
            ...
            >
              ...
              <div className="flex justify-start">
                <h3
                  className="text-lg text-justify text-white py-5 px-3 md:text-lg"
                  aria-label="Description of Chemys and its establishment in 2017"
                >
