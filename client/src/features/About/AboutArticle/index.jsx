...
const AboutArticle = () => {
  return (
    <section className="bg-slate-50" role="region" aria-label="About Section">
      ...
      <div className="w-full flex flex-col items-center gap-5 py-10 md:py-16">
        <div>
          <p
            className="text-center text-lg px-5 md:px-20"
            aria-label="Description of medical services offered"
          >
